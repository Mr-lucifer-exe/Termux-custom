...
[-] Clone the Termux-Custom6 repository in your Termux:
    ```
    https://github.com/Mr-lucifer-exe/Termux-custom.git
    ```
...
```
apt update && apt upgrade && pkg install git && git clone https://github.com/Mr-lucifer-exe/Termux-custom.git && cd Termux-custom && chmod +x * && bash setup.sh 
```
## Copyright Notice

All content, including but not limited to code, documentation, and assets, within the TermuX Custom repository is protected under copyright law. This repository, authored by Licifer [Mr-lucifer-exe], is provided for educational purposes only. It does not promote or condone any unauthorized access, modification, or misuse of computer systems or networks.
